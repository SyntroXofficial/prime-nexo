          ...
          <div className="p-8 space-y-8">
            ...
            <div className="bg-black/30 rounded-xl p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-lg font-semibold text-gray-300 mb-4">Recommended</h3>
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      <span className={`h-2 w-2 rounded-full ${rarityConfig.bgColor} mt-2`}></span>
                      <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <p className="text-gray-400">Genre: <span className="text-white">{account.features.find(f => f.label === 'Genre')?.value}</span></p>
                    <p className="text-gray-400">Release Date: <span className="text-white">{account.features.find(f => f.label === 'Release')?.value}</span></p>
                    <p className="text-gray-400">Average Playtime: <span className="text-white">{account.features.find(f => f.label === 'Playtime')?.value}</span></p>
                    <p className="text-gray-400">Rating: <span className="text-white">{account.features.find(f => f.label === 'Rating')?.value}</span></p>
                    <p className="text-gray-400">Region: <span className="text-white">{account.features.find(f => f.label === 'Region')?.value}</span></p>
                    <p className="text-gray-400">Platform: <span className="text-white">{account.features.find(f => f.label === 'Platform')?.value}</span></p>
                  </div>
                </div>
              </div>
            </div>
