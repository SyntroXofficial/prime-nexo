...
export default function EpicGames() {
  ...
  const method = methods.find(m => m.id === 'epic-games');
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        >
          <div className="relative h-[400px]">
            <img
              src="https://preview.redd.it/mystery-game-gift-wrapping-v0-7ur8bkyswg7a1.jpg?width=1080&crop=smart&auto=webp&s=25a5e458ff77a7671808f7c0409bded466ad5a8d"
              alt={method.title}
